        ...
        <div className="container-fluid">
            <div className="row h-screen">
                ...
                <div className="col-sm-12 col-md-6 bg-white m-auto px-0 px-lg-5">
                    <div className="container px-md-5">
                     ...
                     <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="mb-3">
                            ...
                            <input type="text" className={`form-control form-control-lg ${errors.fullName ? 'is-invalid' : ''}`} name="fullName" id="fullName" placeholder="eg. John Doe" {...register("fullName", { required: true })}/>
                            <div className="invalid-feedback">{errors?.fullName?.message}</div>
                        </div>
                        <div className="mb-3">
                            <label htmlFor="emailAddress" className="form-label">Email address</label>
                            <input type="email" className={`form-control form-control-lg ${errors.emailAddress ? 'is-invalid' : ''}`} id="emailAddress" name="emailAddress" placeholder="name@example.com" {...register("emailAddress", { required: true, email: true })} />
                            <div className="invalid-feedback">{errors?.emailAddress?.message}</div>
                        </div>
                        <div className="mb-3">
                            <label htmlFor="password" className="form-label">Password</label>
                            <input type="password" className={`form-control form-control-lg ${errors.password ? 'is-invalid' : ''}`} id="password" placeholder="password" {...register("password", { required: true })} />
                    ...
                    <div className="mt-3">
                        <p><span className="text-secondary">Already have and account?</span> 
                        <Link href="/login">
